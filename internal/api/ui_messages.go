...
var uiMessages = map[string]map[string]string{
	"en": {
		...
		"settings.connect_x_static_hint":      "x connects via oauth1a when api key/secret are set and also supports static oauth1 credentials via env, API, or CLI",
	...
	"es": {
		...
		"settings.connect_x_static_hint":      "x se conecta por oauth1a cuando api key/secret están configuradas y también soporta credenciales oauth1 estáticas vía env, API o CLI",
