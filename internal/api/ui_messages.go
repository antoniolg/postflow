...
var uiMessages = map[string]map[string]string{
	"en": {
		...
		"settings.connect_via_oauth":          "connect via oauth (linkedin, facebook, instagram)",
		"settings.connect_x_static_hint":      "x currently uses static credentials via env, API, or CLI",
	...
	"es": {
		...
		"settings.connect_via_oauth":          "conectar via oauth (linkedin, facebook, instagram)",
		"settings.connect_x_static_hint":      "x usa actualmente credenciales estaticas via env, API o CLI",
