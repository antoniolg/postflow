...
var uiMessages = map[string]map[string]string{
	"en": {
		...
		"settings.connect_x_static_hint":      "x also supports static oauth1 credentials via env, API, or CLI",
	...
	"es": {
		...
		"header.edit_post":                    "EDITAR PUBLICACION",
		"common.back":                         "volver",
		"common.today":                        "hoy",
		...
		"publications.empty":                  "No hay publicaciones programadas o en curso para los proximos %d dias.",
		...
		"create.preview_empty_step":           "Aun no hay copy para este paso.",
		...
		"settings.connect_via_oauth":          "conectar via oauth (x, linkedin, facebook, instagram)",
		"settings.connect_x_static_hint":      "x tambien soporta credenciales oauth1 estaticas via env, API o CLI",
		...
		"settings.oauth_selection_hint":       "Hemos encontrado %d cuentas. Elige cuales conectar.",
		...
		"settings.oauth_selection_expired":    "la seleccion de cuentas ha expirado. conecta otra vez",
