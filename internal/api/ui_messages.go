...
var uiMessages = map[string]map[string]string{
	"en": {
		...
		"settings.media_purge":                "purge published media",
		"settings.media_purge_confirm":        "Delete media only used by already published posts? Media linked to drafts/scheduled posts will be kept.",
	...
	"es": {
		...
		"settings.media_purge":                "purgar multimedia publicada",
		"settings.media_purge_confirm":        "Eliminar multimedia usada solo por publicaciones ya publicadas? Se conservara la multimedia en borradores o programadas.",
